...
#ifndef USER_GESTURE_H
#define USER_GESTURE_H
#pragma once
...
///////////////////////
#define GESTURE_SENSOR_SDA  D14
#define GESTURE_SENSOR_SCL  D15
#define GESTURE_SENSOR_ADDR 132
...
public:
	void MasterRead(uint8_t *pdata,int reclength,uint16_t address);
